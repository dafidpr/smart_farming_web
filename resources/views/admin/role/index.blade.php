                ...
                <div class="toggle-wrap nk-block-tools-toggle">
                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            @can('create-roles') 
                                <li><a href="#myModal" data-toggle="modal" class="btn btn-light bg-white add add-role"><em class="icon ni ni-plus"></em><span>Tambah Role Baru</span></a></li>
                            @endcan
                        </ul>
                    </div>
                </div><!-- .toggle-wrap -->
...
@component('admin._components.modal')
    @slot('id', 'myModal')
    @slot('title', 'Tambah Role Baru')
    @slot('form')
        <form action="" method="POST" id="formSubmit">
    @endslot
    @include('admin.role._partials.form')
@endcomponent
@endsection