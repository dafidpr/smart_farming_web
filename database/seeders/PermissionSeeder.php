...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        Permission::insert([
            ...
            ['name' => 'read-schedules', 'guard_name' => 'web', 'is_default' => 'Y'],
            ['name' => 'create-schedules', 'guard_name' => 'web', 'is_default' => 'Y'],
            ['name' => 'update-schedules', 'guard_name' => 'web', 'is_default' => 'Y'],
            ['name' => 'delete-schedules', 'guard_name' => 'web', 'is_default' => 'Y'],
